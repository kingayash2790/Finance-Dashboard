...
export default function Sidebar() {
  ...
  return (
    <>
      <div className="bg-gray-900 text-gray-300 h-screen p-4">
        <div className="text-center">
          <button
            className="text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            type="button"
        ...
        <div
          className={`fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform transform ${
          ...
          <div className="py-4 overflow-y-auto">
            <ul className="space-y-2 font-medium">
              <li>
                <a
                  href="#"
                  className="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 hover:text-white dark:hover:bg-gray-700 group"
                >
                  <svg
              ...
              <li>
                ...
                >
                  ...
                  >
                    ...
                    <path d="M8.961 16a.93.93 0 0 0 .189-.019l3.4-.679a.961.961 0 0 0 .49-.263l6.118-6.117a2.884 2.884 0 0 0-4.079-4.078l-6.117 6.117a.96.96 0 0 0-.263.491l-.679 3.4A.961.961 0 0 0 8.961 16Zm7.477-9.8a.958 2.884 0 0 1 .68-.281.961.961 0 0 1 .682 1.644l-.315.315-1.36-1.36.313-.318Zm-5.911 5.911 4.236-4.236 1.359 1.359-4.236 4.237-1.7.339.341-1.699Z" />
                  </svg>
...
//                     <li className="mb-4">Trade</li>
//                     <li className="mb-4">Wallet</li>
//                     <li className="mb-4">Analytics</li>
//                 </ul>
...
//                 <img className="rounded-full h-10 w-10 mr-4" src="path/to/image.jpg" alt="Ralph's Wallet"/>
//                 <span>Ralph's Wallet</span>
//             </div>
//         </div>
//     );
// };
